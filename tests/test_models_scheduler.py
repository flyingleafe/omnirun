...
for Slot and Placement (Task 1); JobPolicy/Deadline defaults, JobSpec policy
serialization, JobRecord new-field defaults, and urgency ordering (Task 2).
"""
...
# ---------------------------------------------------------------------------
# Task 2: JobPolicy / Deadline defaults
# ---------------------------------------------------------------------------
